...
insert into role (name, id) values ('ADMIN', 3);
insert into role (name, id) values ('USER', 4);
...
insert into user (id, username, email, password, enabled, created) values (1, 'test','test@mail.com', 'password', true, '2017-09-13 00:00:00');
